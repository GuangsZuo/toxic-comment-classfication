...
meta_features=["caps_vs_length","num_exclamation_marks","num_question_marks","num_punctuation","num_symbols",
               "num_words", "words_vs_unique","num_smilies", "total_length", "words_vs_length"]
train_oofs = [textcnn_oofs[lables], bigru_conv1d_oofs[lables], lr_oofs[lables],bigru2_oofs[lables],xgb_oofs[lables],
              bigru_att_oofs[lables], charcnn_oofs[lables] ,textcnn2_oofs[lables], fm_oofs[lables], nbsvm_oofs[lables],
              lgbm_oofs[lables],bigru2_rank_oofs[lables], bigru_conv_rank_oofs[lables],
              capsule_oofs[lables], bigru_conv_prepro_nocu_oofs[lables],bigru2_prepro_nocu_oofs[lables],
              train[meta_features]]
test_subs = [textcnn_subs[lables_1], bigru_conv1d_subs[lables_1], lr_subs[lables_1], bigru2_subs[lables_1], xgb_subs[lables_1],
             bigru_att_subs[lables_1], charcnn_subs[lables_1], textcnn2_subs[lables_1], fm_subs[lables_1], nbsvm_subs[lables_1],
             lgbm_subs[lables_1],bigru2_rank_subs[lables_1], bigru_conv_rank_subs[lables_1],
             capsule_subs[lables_1],bigru_conv_prepro_nocu_subs[lables_1],bigru2_prepro_nocu_subs[lables_1],
             test[meta_features]]
...
shit_2.to_csv("xgb_stacking_oofs.csv")

submission[["toxic", "severe_toxic", "obscene", "threat", "insult", "identity_hate"]] = y_pred
submission.to_csv('xgb_stacking_final.csv', index=False)
