...
from keras.layers import CuDNNGRU,GRU, Conv1D, Bidirectional, GlobalAveragePooling1D, GlobalMaxPooling1D,Dropout,Flatten,                 Activation,Reshape,RepeatVector,Permute,MaxPooling1D,Lambda,BatchNormalization as bn
